...
public class Facilities {
    ...
    public static Status statusOfBuilding(WebDriver w, DataTechnology dataTechnology) {
        try {
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download status of " +dataTechnology);
        }
    ...
    public static boolean stopUpgradeBuilding(WebDriver w,DataTechnology dataTechnology){
        try {
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"While try stop upgrade " + dataTechnology);
        }
        return false;
    }
    ...
    public static boolean clickOnBuilding(WebDriver w, DataTechnology dataTechnology){
        try{
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"While trying to click on a building: " + dataTechnology);
        }
        return false;
    }
    ...
    public static int levelOfBuilding(WebDriver w, DataTechnology dataTechnology) {
        try {
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download level of " + dataTechnology);
        }
        return -1;
    }
    ...
    public static String dataTechnologyOfBuilding(WebDriver w, DataTechnology dataTechnology) {
        try {
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download data technology of " + dataTechnology);
        }
        return "-1";
    }
    ...
    public static String localNameOfBuilding(WebDriver w, DataTechnology dataTechnology) {
        try {
            ...
            AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download local name of " + dataTechnology);
        }
        return "null";
    }
    ...
    public static long startDateOfUpgradeBuilding(WebDriver w, DataTechnology dataTechnology){
        if(statusOfBuilding(w,dataTechnology.getListIndex()) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download start data of " + dataTechnology.getListIndex());
            }
        }
        return -1;
    }
    ...
    public static long endDateOfUpgradeBuilding(WebDriver w, DataTechnology dataTechnology){
        if(statusOfBuilding(w,dataTechnology.getListIndex()) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download end data of " + dataTechnology);
            }
        }
        return -1;
    }
    ...
    public static long productionTimeOfUpgradedBuildingInSeconds(WebDriver w, DataTechnology dataTechnology){
        if(statusOfBuilding(w,dataTechnology.getListIndex()) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Facilities.class.getName(),1,"Doesn't download production time of " + dataTechnology);
            }
        }
        return -1;
    }

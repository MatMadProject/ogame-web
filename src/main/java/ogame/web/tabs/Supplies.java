...
import ogame.web.DataTechnology;
import ogame.web.FinalXPath;
import ogame.web.Status;
import ogame.web.Type;
import ogame.web.buildings.RequiredResources;
import ogame.web.utils.WebElementPath;
import ogame.web.utils.WebElementUtil;
import ogame.web.utils.log.AppLog;
import ogame.web.watch.ProductionTime;
...
public class Supplies {
    ...
    private static final String SUPPLIES_BUTTON = "//*[@id=\"menuTable\"]/li[2]/a";
    private static final String SUPPLIES_COMPONENT_ID = "suppliescomponent";
    private static final String BUILDING_DETAILS_VISIBLE = "slide-up";
    private static final String BUILD_DURATION = "build_duration";
    private static final String ENERGY_PRODUCTION = "energy_production";
    private static final String ENERGY_CONSUMPTION = "additional_energy_consumption";
    ...
    private static final String BUILDINGS = "//*[@id=\"producers\"]";
    ...
    private static final WebElementPath BUILDINGS_CONTAINER = new WebElementPath(BUILDINGS.concat("/li["),"]");
    ...
    public static boolean visible(WebDriver w) {
        try{
            ...
            return s.contains(SUPPLIES_COMPONENT_ID);
        }
        catch (Exception e){
            AppLog.printOnConsole(Supplies.class.getName(),1,"When it checks, the tab is visible.");
        }
        return false;
    }
    ...
    public static boolean click(WebDriver w){
        try{
            ...
            WebElement e =  w.findElement(By.xpath(SUPPLIES_BUTTON));
            e.click();
            return true;
        }
        catch (Exception e){
            AppLog.printOnConsole(Supplies.class.getName(),1,"While trying to click on a tab.");
        }
        return false;
    }
    ...
    public static boolean acceptDecisionOnErrorBox(WebDriver w){
        try{
            ...
            AppLog.printOnConsole(Supplies.class.getName(),1,"While trying to click on a error box - accept decision.");
        }
        return false;
    }
    ...
    public static boolean declineDecisionOnErrorBox(WebDriver w){
        try{
            ...
            AppLog.printOnConsole(Supplies.class.getName(),1,"While trying to click on a error box - decline decision.");
        }
        return false;
    }
    ...
    public static ProductionTime productionTimeOfBuilding(WebDriver w){
        try {
            ...
            AppLog.printOnConsole(Supplies.class.getName(),1,"While try download production time.");
        }
    ...
    public static long startDateOfUpgradeBuilding(WebDriver w, int pos){
        if(statusOfBuilding(w,pos) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Supplies.class.getName(),1,"Doesn't download start data of " + DataTechnology.getFromListIndex(pos, Type.PRODUCTION));
            }
        }
        return -1;
    }
    ...
    public static long endDateOfUpgradeBuilding(WebDriver w, int pos){
        if(statusOfBuilding(w,pos) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Supplies.class.getName(),1,"Doesn't download end data of " + DataTechnology.getFromListIndex(pos, Type.PRODUCTION));
            }
        }
        return -1;
    }
    ...
    public static long productionTimeOfUpgradedBuildingInSeconds(WebDriver w, int pos){
        if(statusOfBuilding(w,pos) == Status.ACTIVE){
            try {
                ...
                AppLog.printOnConsole(Supplies.class.getName(),1,"Doesn't download production time of " + DataTechnology.getFromListIndex(pos, Type.PRODUCTION));
            }
        }
        return -1;
    }
